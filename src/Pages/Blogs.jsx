...
const Blogs = () => {
    return (
        <div className='container mx-auto p-8 bg-black rounded-xl mt-8 shadow-xl '>
            <div data-aos="fade-down"  className=' bg-zinc-900 text-white p-3 rounded'>
                ...
                <br />
                <h2 data-aos="fade-down" className='text-xl text-gray-300 '>Answer: <br /> Access tokens are short-lived tokens that are used to access protected resources. They are typically issued for a limited period of time, such as 30 minutes or an hour.</h2>
            ...
            <div data-aos="fade-down" className=' bg-zinc-900 text-white p-3 mt-2 rounded'>
