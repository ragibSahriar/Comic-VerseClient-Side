...
const Blogs = () => {
    return (
        <div className='container mx-auto p-8 bg-zinc-200 rounded-xl mt-8 shadow-xl'>
            <div className=' bg-sky-500 text-white p-3 rounded'>
                ...
                <br />
                <h2 className='text-xl'>Answer: <br /> Access tokens are short-lived tokens that are used to access protected resources. They are typically issued for a limited period of time, such as 30 minutes or an hour.</h2>
            ...
            <div className=' bg-sky-500 text-white p-3 mt-2 rounded'>
